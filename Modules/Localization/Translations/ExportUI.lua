...
local exportUILocales = {
  ...
  ["Copy the text below and submit it at the URL above. This data helps us build the Questie database. Player and guild names are never included."] = {
    ...
    ["esES"] = "Copia el texto de abajo y envíalo a la URL de arriba. Estos datos nos ayudan a construir la base de datos de Questie. Los nombres de jugadores y hermandades nunca se incluyen.",
    ["esMX"] = "Copia el texto de abajo y envíalo a la URL de arriba. Estos datos nos ayudan a construir la base de datos de Questie. Los nombres de jugadores y hermandades nunca se incluyen.",
    ...
    ["itIT"] = "Copia il testo qui sotto e invialo all'URL qui sopra. Questi dati ci aiutano a costruire il database di Questie. I nomi dei giocatori e delle gilde non vengono mai inclusi.",
  ...
  ["Nothing new to share yet. Keep playing and check back later."] = {
    ...
    ["itIT"] = "Ancora niente di nuovo da condividere. Continua a giocare e ricontrolla più tardi.",
  ...
  ["ERROR: Client does not have required codec support (C_EncodingUtil, Enum.CompressionMethod, LibDeflate)"] = {
    ...
    ["itIT"] = "ERRORE: il client non dispone del supporto codec richiesto (C_EncodingUtil, Enum.CompressionMethod, LibDeflate)",
