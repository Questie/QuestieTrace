...
local consentLocales = {
  ["Help improve Questie by allowing QuestieTrace to collect anonymized gameplay data, such as quest progress, positions, and loot. Your data stays on your machine unless you choose to export and share it. Do you want to help out Questie?"] = {
    ...
    ["esES"] = "Ayuda a mejorar Questie permitiendo que QuestieTrace recopile datos de juego anonimizados, como progreso de misiones, posiciones y botín. Tus datos permanecen en tu equipo a menos que decidas exportarlos y compartirlos. ¿Deseas ayudar a Questie?",
    ...
    ["frFR"] = "Aidez-nous à améliorer Questie en permettant à QuestieTrace de collecter des données de jeu anonymisées, telles que la progression des quêtes, les positions et le butin. Vos données restent sur votre machine, sauf si vous choisissez de les exporter et de les partager. Voulez-vous aider Questie ?",
    ...
    ["ptBR"] = "Ajude a melhorar o Questie permitindo que o QuestieTrace colete dados de jogo anonimizados, como progresso de missões, posições e saques. Seus dados permanecem na sua máquina, a menos que você decida exportá-los e compartilhá-los. Você gostaria de ajudar o Questie?",
  ...
  ["Thank you for helping improve Questie! Your gameplay data is being collected locally on this device."] = {
    ...
    ["esES"] = "¡Gracias por ayudar a mejorar Questie! Tus datos de juego se están recopilando localmente en este dispositivo.",
    ["esMX"] = "¡Gracias por ayudar a mejorar Questie! Tus datos de juego se están recopilando localmente en este dispositivo.",
    ["frFR"] = "Merci de nous aider à améliorer Questie ! Vos données de jeu sont collectées localement sur cet appareil.",
    ["koKR"] = "Questie 개선에 도움을 주셔서 감사합니다! 게임 데이터가 이 기기에 로컬로 수집되고 있습니다.",
    ["ptBR"] = "Obrigado por ajudar a melhorar o Questie! Seus dados de jogo estão sendo coletados localmente neste dispositivo.",
