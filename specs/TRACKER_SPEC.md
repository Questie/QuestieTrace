...
| UnitState | `Trackers/UnitState.lua` | `UnitLevel`/`UnitClassification` for `target`, `mouseover` | Event-driven fixed unit-token fanout (NPC-only) | `PLAYER_TARGET_CHANGED`, `UPDATE_MOUSEOVER_UNIT` |
